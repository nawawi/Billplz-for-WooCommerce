...
function prefix_plugin_update_message_bfw($data, $response)
{
    printf(
        '<div class="update-message"><h1><strong>%s</strong></h1></div>',
        __('VERSION 3.20.x IS A MAJOR RELEASE. PROCEED WITH CAUTION', 'wcbillplz')
    );
}
add_action('in_plugin_update_message-billplz-for-woocommerce/billplzWoo.php', 'prefix_plugin_update_message_bfw', 10, 2);
